...
export class MarketService {
  ...
  private url = 'http://localhost:8080/api/v2/marketr';
  private createUrl = 'http://localhost:8080/api/v2/marketr';
  ...
  listLive(): Observable<Market[]> {
    // @ts-ignore
    return this.http.get('http://localhost:8080/api/v2/marketr');
  }
